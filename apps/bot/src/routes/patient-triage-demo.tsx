    ...
    <div className="flex h-full min-h-0 w-full min-w-0 flex-1 shrink-0 basis-0 flex-col items-start bg-neutral-50">
      ...
      <div className="flex w-full flex-col items-start border-b border-solid border-neutral-border bg-default-background px-4 py-4 md:px-6">
        <div className="flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex w-fit shrink-0 items-center gap-2 self-start rounded-full bg-success-100 px-3 py-1">
...
function ChatContent({
  ...
  return (
    <>
      ...
      <div
        ref={scrollRef}
        className="flex w-full min-w-0 grow shrink-0 basis-0 flex-col items-start gap-4 overflow-auto px-4 py-4 md:px-6 md:py-6"
      >
        {messages.length === 0 ? (
