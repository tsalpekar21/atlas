...
/*
 * Documentation:
 * Avatar — https://app.subframe.com/1a56b7bac267/library?component=Avatar_bec25ae6-5010-4485-b46b-cf79e3943ab2
 * Dropdown Menu — https://app.subframe.com/1a56b7bac267/library?component=Dropdown+Menu_99951515-459b-4286-919e-a89e7549b43b
 * Icon Button — https://app.subframe.com/1a56b7bac267/library?component=Icon+Button_af9405b1-8c54-4e01-9786-5aad308224f6
 * Sidebar — https://app.subframe.com/1a56b7bac267/library?component=Sidebar_be69cb9c-cae2-4746-90c6-ef3d7b3131ed
 * Sidebar with sections — https://app.subframe.com/1a56b7bac267/library?component=Sidebar+with+sections_f4047c8b-cfb4-4761-b9cf-fbcae8a9b9b5
 */
...
const SidebarRoot = React.forwardRef<HTMLDivElement, SidebarRootProps>(
  function SidebarRoot(
    { children, className, ...otherProps }: SidebarRootProps,
    ref
  ) {
    return (
      <div
      ...
      >
        ...
        >
          ...
          <SidebarWithSections.NavSection label="EHR">
